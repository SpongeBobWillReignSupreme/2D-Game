...
public class Enemy
{
    ...
    public boolean checkStomp(Player p)
    {
        ...
        if((p.getX() + p.getWidth() >= eX && p.getX() + p.getWidth() <= eX + eW && p.getY() + p.getHeight() >= eY && p.getY() + p.getHeight() <= eY + eH/4) || (p.getX() >= eX && p.getX() <= eX + eW && p.getY() + p.getHeight() >= eY && p.getY() + p.getHeight() <= eY + eH/4))
        {
            p.setVY(-15);
            return true;
        }
    ...
    {
        if((p.getX() + p.getWidth() >= eX && p.getX() + p.getWidth() <= eX + eW && p.getY() + p.getHeight()/2 > eY && p.getY() + p.getHeight()/2 <= eY + eH) || (p.getX() >= eX && p.getX() <= eX + eW && p.getY() + p.getHeight()/2 > eY && p.getY() + p.getHeight()/2 <= eY + eH))
        {
            p.setVY(-15);
